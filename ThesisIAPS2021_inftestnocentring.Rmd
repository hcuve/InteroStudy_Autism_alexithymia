...
db_full6new_hr_fix_stim_select2_NT_no_outl_3<- select(db_full6new_hr_fix_stim_select2_NT_no_outl,
                                                      c(ssid, stimIAPS, stimIAPS2, stimDescription, TAS, pup_basCor, Bio_Mean_HR_dif, log1p_BIO_CDA.PhasicMax, arousal, valence))
...
# scr
colnames(db_forBADA1)
db_forBADA1_ar_vl<- db_forBADA1[,c(1:2,171:282)]
# table(is.na(db_forBADA1_pupil$TAS))
...
db_badia_nona <- bind_cols(db_forBADA1_pupil, db_forBADA1_hr[,3:58], db_forBADA1_scr[,3:58], db_forBADA1_ar_vl[,3:114])

colnames(db_badia_nona)
db_badia_nona1<- db_badia_nona[,c(1:2,59,3:58,60:283)]
