...
db_full6new_hr_fix_stim_select4 <- select(db_full6new_hr_fix_stim_select3,
                                                      c(ssid, Group,TAS, AQ, stimIAPS, stimIAPS2, stimDescription, pup_basCor, Bio_Mean_HR_dif, log1p_BIO_CDA.PhasicMax, arousal, valence))
...
var.PCA.inf_asd2.2 <-InPosition::epPCA.inference.battery(var.data_asd_agg, 
                                       scale = FALSE, 
                                       center = TRUE, 
...
var.PCA.inf_agg_aq <-InPosition::epPCA.inference.battery(var.data_asd_agg, 
                                       scale = FALSE, 
                                       center = TRUE, 
...
# tas
var.PCA.inf_agg_tas <-InPosition::epPCA.inference.battery(var.data_asd_agg, 
                                       scale = FALSE, 
                                       center = TRUE, 
