...
left_join(dta_bhv_quest,dta_beh_labels)
left_join(dta_beh_labels,dta_bhv_quest)
dta_beh_labels

dta_bhv_quest<- dta_bhv_quest%>%
  group_by(ssid)%>%
  mutate(new_index_stim = 1:n())

dta_bhv_quest1<-dta_bhv_quest
dta_bhv_quest2<- dta_bhv_quest
dta_bhv_quest3<-dta_bhv_quest
dta_bhv_quest4<-dta_bhv_quest

dta_bhv_quest1$screen_content<- "fixation"
dta_bhv_quest2$screen_content<- "stimuli"
dta_bhv_quest3$screen_content<- "valence"
dta_bhv_quest4$screen_content<- "intensity"

dta_bhv_quest1$screen_content_no<- 1
dta_bhv_quest2$screen_content_no<- 2
dta_bhv_quest3$screen_content_no<- 3
dta_bhv_quest4$screen_content_no<- 4
