...
now physiology models 

```{r}
dta_4_lmms_sel_1_w_impt$bio_cda_phasicmax_no_outl_imptd
dta_4_lmms_sel_1_w_impt$bio_cda_phasicmax

table(is.na((dta_4_lmms_sel_1_w_impt$bio_cda_phasicmax_no_outl_imptd+.1)))
...
mod_lmer$cda_phasmax_0 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
mod_lmer$cda_phasmax_1 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+tas_imptd_z*arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
#and arousal effects
# 
mod_lmer$cda_phasmax_2 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+aq_imptd_z*arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
anova(mod_lmer$cda_phasmax_0, mod_lmer$cda_phasmax_1, mod_lmer$cda_phasmax_2)
...
# now test direct effects
mod_lmer$cda_phasmax_3 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+tas_imptd_z_asid*arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
#and arousal effects ho0ld
# 

mod_lmer$cda_phasmax_4 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+aq_imptd_z_asid*arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
anova(mod_lmer$cda_phasmax_0, mod_lmer$cda_phasmax_1, mod_lmer$cda_phasmax_2,mod_lmer$cda_phasmax_3,mod_lmer$cda_phasmax_4)
...
mod_lmer$cda_phasmax_0_nt <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt_nt)

mod_lmer$cda_phasmax_0.1_nt <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt_nt)


mod_lmer$cda_phasmax_5 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+tas_imptd_z*arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt_nt)
...
mod_lmer$cda_phasmax_6 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+aq_imptd_z*arousal_0_1_z+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                    data = dta_4_lmms_sel_1_w_impt_nt)
...
anova(mod_lmer$hr_dif_0, mod_lmer$hr_dif_1, mod_lmer$hr_dif_2 )
...
anova(mod_lmer$pup_0, mod_lmer$pup_1, mod_lmer$pup_2 )
# autism model winds
...
anova(mod_lmer$pup_0, mod_lmer$pup_1, mod_lmer$pup_2, mod_lmer$pup_3, mod_lmer$pup_4 )
```

coherence among physiology

```{r}
dta_4_lmms_sel_1_w_impt$bio_cda_phasicmax_no_outl_imptd_log1p<- log1p(dta_4_lmms_sel_1_w_impt$bio_cda_phasicmax_no_outl_imptd+.109)

mod_lmer$cda_phasmax_from_hr_0 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+bio_mean_hr_dif_no_outl_imptd+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
mod_lmer$cda_phasmax_from_hr_1 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+bio_mean_hr_dif_no_outl_imptd+
...
mod_lmer$cda_phasmax_from_hr_2 <- lmer(log1p(bio_cda_phasicmax_no_outl_imptd+.109) ~ 1+bio_mean_hr_dif_no_outl_imptd+
...
mod_lmer$hr_from_cda_phasmax_0 <- lmer(bio_mean_hr_dif_no_outl_imptd ~ 
                                         1+bio_cda_phasicmax_no_outl_imptd_log1p+ (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
mod_lmer$hr_from_cda_phasmax_1 <- lmer(bio_mean_hr_dif_no_outl_imptd ~ 1+bio_cda_phasicmax_no_outl_imptd_log1p+
                                         
                                         tas_imptd_z:bio_cda_phasicmax_no_outl_imptd_log1p + (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
mod_lmer$hr_from_cda_phasmax_2 <- lmer(bio_mean_hr_dif_no_outl_imptd ~ 1+bio_cda_phasicmax_no_outl_imptd_log1p+
                                         
                                         aq_imptd_z:bio_cda_phasicmax_no_outl_imptd_log1p + (1 | stimiaps2)  + 
                                 (1 | ssid), REML = FALSE,
                      data = dta_4_lmms_sel_1_w_impt)
...
dta_4_lmms_sel_1_w_impt%>%
  group_by(ssid)%>%
  select(bio_mean_hr_dif_no_outl_imptd,
         bio_cda_phasicmax_no_outl_imptd,
...
dta_4_lmms_sel_1_w_impt %>%
  group_by(ssid) %>%
  summarise(
    cor_mat = list(cor(across(all_of(vars)), use = "pairwise.complete.obs")),
    .groups = "drop"
  ) %>%
  # turn matrix into long format
  mutate(cor_long = lapply(cor_mat, \(m) {
    as.data.frame(as.table(m))
  })) %>%
  select(-cor_mat) %>%
  unnest(cor_long) %>%
  rename(var1 = Var1, var2 = Var2, r = Freq) %>%
  # keep only unique pairs (upper triangle without diagonal)
  filter(var1 < var2) %>%
  # spread into wide format → one column per correlation
