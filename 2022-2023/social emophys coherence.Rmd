...
dta_cor %>%
  ...
  ggplot(aes(x = social_nonsocial, y = rho,colour = social_nonsocial)) +  
...
dta_vars_4mfa_2_wide_sel2<- dta_vars_4mfa_2_wide_sel2%>%
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(aq28_total_cont,mfa_z_sid_coord_1))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()+
    geom_text(aes(label = participant))
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(aq28_total_cont,mfa_z_sid_coord_2))+
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(aq28_total_cont,mfa_z_sid_coord_3))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()+
    geom_text(aes(label = participant))
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(tas20_total,mfa_z_sid_coord_1))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()

dta_vars_4mfa_2_wide_sel2%>%
  mutate(group = if_else(as.numeric(participant)< 200, "social", "nonsocial"))%>%


  ggplot(aes(tas20_total, abs(mfa_z_sid_coord_2), colour = group))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(tas20_total,mfa_z_sid_coord_3))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()+
  geom_text(aes(label = participant))
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(aq28_total_cont,mfa_z_sid_contrib_1))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()+
    geom_text(aes(label = participant))
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(aq28_total_cont,mfa_z_sid_contrib_2))+
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(aq28_total_cont,mfa_z_sid_contrib_3))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()+
    geom_text(aes(label = participant))
...
dta_vars_4mfa_2_wide_sel2%>%
  ...
  ggplot(aes(tas20_total,mfa_z_sid_contrib_1))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()
...
dta_vars_4mfa_2_wide_sel2%>%
 ...
 mutate(group = if_else(as.numeric(participant)< 200, "social", "nonsocial"))%>%
  ggplot(aes(tas20_total,log1p( mfa_z_sid_contrib_2+.1), colour = group))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()
...
dta_vars_4mfa_2_wide_sel%>%
  ...
  ggplot(aes(tas20_total,mfa_z_sid_contrib_3))+
  geom_point()+
  geom_smooth(method = "lm")+
    ggpubr::stat_cor()+
  geom_text(aes(label = participant))
